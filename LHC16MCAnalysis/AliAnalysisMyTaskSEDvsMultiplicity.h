#ifndef ALIANALYSISMYTASKSEDVSMULTIPLICITY_H
#define ALIANALYSISMYTASKSEDVSMULTIPLICITY_H
...
//*************************************************************************
/// \class Class AliAnalysisMyTaskSEDvsMultiplicity
...
class AliAnalysisMyTaskSEDvsMultiplicity : public AliAnalysisTaskSE
{
 public:

  AliAnalysisMyTaskSEDvsMultiplicity();
  AliAnalysisMyTaskSEDvsMultiplicity(const char *name, Int_t pdgMeson, AliRDHFCuts* cuts, Bool_t switchPPb);
  virtual ~AliAnalysisMyTaskSEDvsMultiplicity();
 ...
 private:
  ...
  AliAnalysisMyTaskSEDvsMultiplicity(const AliAnalysisMyTaskSEDvsMultiplicity &source);
  AliAnalysisMyTaskSEDvsMultiplicity& operator=(const AliAnalysisMyTaskSEDvsMultiplicity& source); 
  ...
  /// \cond CLASSIMP
  ClassDef(AliAnalysisMyTaskSEDvsMultiplicity,18); /// charmed hadrons vs. mult task
  /// \endcond
};
