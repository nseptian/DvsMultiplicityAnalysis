...
/*    
    taskName="AddTaskCFVertexingHFCascade.C"; taskName.Prepend(loadMacroPath.Data());
    gROOT->LoadMacro(taskName.Data());
    AliCFTaskVertexingHF *CFtask = AddTaskCFVertexingHFCascade("DStartoKpipiCuts.root","DStartoKpipiCuts","pp13TeV_kINT7",AliCFTaskVertexingHF::kCheetah,kTRUE,kTRUE,413,2,kTRUE,kFALSE,kFALSE,kFALSE,kFALSE,estimatorFilename="estimators.root",AliCFTaskVertexingHF::kNtrk10,kTRUE,kFALSE,11.98,kFALSE);
*/    /*
...
AliAnalysisGrid* CreateAlienHandler(TString pluginmode,Bool_t useParFiles=kFALSE, TString testfileslistWithPlugin="")
{
  ...
  //   source /tmp/gclient_env_$UID in the current shell.
   ...
   plugin->SetGridOutputDir("LHC17d20a1_full_MyDStarvsMultMC_pp13TeV_Split100"); // In this case will be $HOME/work/output
