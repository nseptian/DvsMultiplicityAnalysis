...
#include "MyAliCFTaskVertexingHF.h"
...
MyAliCFTaskVertexingHF::MyAliCFTaskVertexingHF() :
  AliAnalysisTaskSE(),
  fCFManager(0x0),
...
MyAliCFTaskVertexingHF::MyAliCFTaskVertexingHF(const Char_t* name, AliRDHFCuts* cuts, TF1* func) :
...
//___________________________________________________________________________
MyAliCFTaskVertexingHF& MyAliCFTaskVertexingHF::operator=(const MyAliCFTaskVertexingHF& c)
{
  //
  // Assignment operator
  //
...
//___________________________________________________________________________
MyAliCFTaskVertexingHF::MyAliCFTaskVertexingHF(const MyAliCFTaskVertexingHF& c) :
  AliAnalysisTaskSE(c),
  fCFManager(c.fCFManager),
  fHistEventsProcessed(c.fHistEventsProcessed),
...
void MyAliCFTaskVertexingHF::Init()
{
  //
  // Initialization
  //

  if (fDebug>1) printf("MyAliCFTaskVertexingHF::Init()");
...
void MyAliCFTaskVertexingHF::UserExec(Option_t *)
{
  //
  // Main loop function
  //
...
//___________________________________________________________________________
void MyAliCFTaskVertexingHF::Terminate(Option_t*)
{
...
//___________________________________________________________________________
void MyAliCFTaskVertexingHF::UserCreateOutputObjects()
{
...
//_________________________________________________________________________
void MyAliCFTaskVertexingHF::SetPtWeightsFromFONLL276overLHC12a17a(){
...
//_________________________________________________________________________
void MyAliCFTaskVertexingHF::SetPtWeightsFromDataPbPb276overLHC12a17a(){
  // ad-hoc weight function from ratio of
...
//_________________________________________________________________________
void MyAliCFTaskVertexingHF::SetPtWeightsFromFONLL276overLHC12a17b(){
...
//_________________________________________________________________________
void MyAliCFTaskVertexingHF::SetPtWeightsFromFONLL276andBAMPSoverLHC12a17b(){
  // weight function from the ratio of the LHC12a17b MC
  // and FONLL calculations for pp data
...
//_________________________________________________________________________
void MyAliCFTaskVertexingHF::SetPtWeightsFromFONLL5anddataoverLHC16i2a(){
...
//_________________________________________________________________________
void MyAliCFTaskVertexingHF::SetPtWeightsFromFONLL5andLBToverLHC16i2a(){
    // weight function from the ratio of the LHC16i2a MC
...
//_________________________________________________________________________
void MyAliCFTaskVertexingHF::SetPtWeightsFromFONLL5overLHC16i2abc(){
...
//_________________________________________________________________________
void MyAliCFTaskVertexingHF::SetPtWeightsFromFONLL5andBAMPSoverLHC16i2abc(){
  // weight function from the ratio of the LHC16i2a+b+c MC
  // and FONLL calculations for pp data
  // corrected by the BAMPS Raa calculation for 30-50% CC
  if(fHistoPtWeight) delete fHistoPtWeight;
...
//_________________________________________________________________________
void MyAliCFTaskVertexingHF::SetPtWeightsFromFONLL5andTAMUoverLHC16i2abc(){
  // weight function from the ratio of the LHC16i2a+b+c MC
  // and FONLL calculations for pp data
...
//_________________________________________________________________________
void MyAliCFTaskVertexingHF::SetPtWeightsFromFONLL5andDplusdataoverLHC16i2a(){
  // weight function from the ratio of the LHC16i2a MC
...
//_________________________________________________________________________
void MyAliCFTaskVertexingHF::SetPtWeightsFromD0Cent080dataoverLHC16i2abc(){
  //
...
//_________________________________________________________________________
void MyAliCFTaskVertexingHF::SetPtWeightsFromD0Cent080dataModOhoverLHC16i2abc(){
  //
  // weight function from the ratio of the D0 0-80% over lhc16i2abc
...
//_________________________________________________________________________
void MyAliCFTaskVertexingHF::SetPtWeightsFromD0Cent080dataModMartinezoverLHC16i2abc(){
  //
  // weight function from the ratio of the D0 0-80% over lhc16i2abc
...
//_________________________________________________________________________
void MyAliCFTaskVertexingHF::SetPtWeightsFromFONLL5overLHC13d3(){
...
//_________________________________________________________________________
void MyAliCFTaskVertexingHF::SetPtWeightsFromFONLL7overLHC10f6a(){
...
//_________________________________________________________________________
void MyAliCFTaskVertexingHF::SetPtWeightsFromFONLL7overLHC12a12(){
...
//_________________________________________________________________________
void MyAliCFTaskVertexingHF::SetPtWeightsFromFONLL7overLHC12a12bis(){
...
//_________________________________________________________________________
void MyAliCFTaskVertexingHF::SetPtWeightsFromFONLL7overLHC13e2fix(){
...
void MyAliCFTaskVertexingHF::SetPtWeightsFromFONLL5overLHC10f6a(){
  // weight function from the ratio of the LHC10f6a MC
  // and FONLL calculations for pp data
  if(fFuncWeight) delete fFuncWeight;
  fFuncWeight=new TF1("funcWeight","([0]*x)/TMath::Power([2],(1+TMath::Power([3],x/[1])))+[4]*TMath::Exp([5]+[6]*x)+[7]*TMath::Exp([8]*x)",0.15,40.);
...
//________________________________________________________________
void MyAliCFTaskVertexingHF::SetPtWeightsFromFONLL276overLHC10f6a(){
  // weight function from the ratio of the LHC10f6a MC
  // and FONLL calculations for pp data
  if(fFuncWeight) delete fFuncWeight;
...
//_________________________________________________________________________
void MyAliCFTaskVertexingHF::SetPtWeightsFromFONLL5overLHC13d3Lc(){
	// weight function from the ratio of the LHC13d3 MC
...
//_________________________________________________________________________
void MyAliCFTaskVertexingHF::SetPtWeightsFromFONLL5overLHC16i6a(){
...
//_________________________________________________________________________
void MyAliCFTaskVertexingHF::SetPtWeightsFromFONLL7overLHC11b2Lc(){
...
//_________________________________________________________________________
void MyAliCFTaskVertexingHF::SetPtWeightsFromFONLL7overLHC10f7aLc(){
...
//_________________________________________________________________________
void MyAliCFTaskVertexingHF::SetPtWeightsFromFONLL8overLHC15l2a2(){
...
//_________________________________________________________________________
void MyAliCFTaskVertexingHF::SetPtWeightsFromFONLL13overLHC17c3a12(){
...
//_________________________________________________________________________
Double_t MyAliCFTaskVertexingHF::GetWeight(Float_t pt)
{
  //
...
Double_t MyAliCFTaskVertexingHF::dNdptFit(Float_t pt, Double_t* par)
{
  //
  // calculating dNdpt
  //
...
//_________________________________________________________________________
Double_t MyAliCFTaskVertexingHF::GetPtWeightFromHistogram(Float_t pt)
{
  //
...
//__________________________________________________________________________________________________
Double_t MyAliCFTaskVertexingHF::GetZWeight(Float_t z, Int_t runnumber){
  //
...
//__________________________________________________________________________________________________
Double_t MyAliCFTaskVertexingHF::DodzFit(Float_t z, Double_t* par) {
...
//__________________________________________________________________________________________________
Double_t MyAliCFTaskVertexingHF::GetNchWeight(Int_t nch){
  //
...
//__________________________________________________________________________________________________
void MyAliCFTaskVertexingHF::CreateMeasuredNchHisto(){
...
//__________________________________________________________________________________________________
Bool_t MyAliCFTaskVertexingHF::ProcessDs(Int_t recoAnalysisCuts) const{
...
//__________________________________________________________________________________________________
Bool_t MyAliCFTaskVertexingHF::ProcessLctoV0Bachelor(Int_t recoAnalysisCuts) const{
...
TProfile* MyAliCFTaskVertexingHF::GetEstimatorHistogram(const AliVEvent* event){
  ...
  if (fIsPPbData) {    // setting run numbers for LHC13 if pPb
    ...
    if (fYearNumber == 10) {
      ...
      if (runNo>256503 && runNo<258575) period = 0;
      if (runNo>258882 && runNo<260188) period = 1;
      if (period<0 || period>1) return 0; 
    }    
  }
